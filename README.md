# 自述
项目主要是自用的，所以很多地方没写清楚怎么用，如果有感兴趣的朋友可以留 issue。

我自己的使用流程
1. 先准备好多个视频，通常是有多个转场的，方便分割后拼接成多个视频。
2. 准备音频，或者使用本工具的分割音频功能。
3. 标准化视频
```yaml
# 标准化参数
standardize:
...
不同品新建一个子目录就可以
 ...
 我目前抖店都推用这个工具做的视频，效果还行
 如果你比较注重视频质量，那这个工具肯定不适合
...
要分割的话建议先运行第八条标准化视频。运行分割标准化后的视频。
